...
\usepackage[
  ...
  pdfauthor={Jesus Enrique Escobedo Del Castillo},
  pdftitle={Tarea 6: Problemas EXPLICIT-REFS},
  pdfkeywords={UniSon, Ciencias de la Computación, 2022-I}
]{hyperref}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Lenguajes de Programación} %Nombre de la materia
\fancyhead[C]{Lic. en Ciencias de la Computacion} % Nombre del alumno
\fancyhead[R]{Universidad de Sonora} % Email
\fancyfoot[R]{}
...
\author{Por: Jesus Enrique Escobedo Del Castillo} %Como el nombre del autor ya viene en el encabezado
